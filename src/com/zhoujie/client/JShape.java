...
public class JShape implements Shape {
	...
	public JShape(int x, int y, int dir) {
		super();
		this.x = x;
		this.y = y;
		this.dir = dir;
	...
	private Shape newTShapeIfNotConflict(JShape t) {
		this.setMatrix(0);
		if (!t.conflict()) {
			t.setMatrix(1);
			return t;
	...
	@Override
	public Shape left() {
		return newTShapeIfNotConflict(new JShape(x-1,y,dir));
	}
	...
	@Override
	public Shape down() {
		return newTShapeIfNotConflict(new JShape(x,y-1,dir));
	}
	...
	public Shape clockWise() {
		return newTShapeIfNotConflict(new JShape(x,y,(dir+1)%4));
	}

	@Override
	public Shape couterClockWise() {
		return newTShapeIfNotConflict(new JShape(x,y,(dir+3)%4));
	}
}
